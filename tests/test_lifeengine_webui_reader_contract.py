...
KNOWN_UNSURFACED = {
    ...
    "goal_milestones": "goal milestones have no goals panel yet",
    "goal_progress_entries": "goal progress ledger has no goals panel yet",
    "goals": "durable goals are written but no goals panel exists yet",
    ...
    "life_rhythm_items": "rhythm recommendations are not shown in the Observatory",
