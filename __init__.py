...
TOOL_REGISTRY = [
        ...
        ("life_living", schemas.LIFE_LIVING, tools.life_living, "Concrete living rhythm, Canon consistency, resource presets, and paper notes", "🏮"),
        ...
        ("life_venture", schemas.LIFE_VENTURE, tools.life_venture, "Venture (营生): register/cancel an engine-materialized occupation", "🪧"),
        ("life_activity", schemas.LIFE_ACTIVITY, tools.life_activity, "Venture (营生) — back-compat alias of life_venture", "🪧"),
...
def register(ctx):
    ...
    ctx.register_command("life", slash_life, description="Manage LifeEngine", args_hint="help|status|setup|commit|pause|resume|run|call|schedule|review|config|living|closet|behavior|context|doctor|backup|advanced")
