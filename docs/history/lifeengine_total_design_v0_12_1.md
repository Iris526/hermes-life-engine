# LifeEngine v0.12.2 — WebUI Live Observatory 增强设计

## 目标

v0.12.2 继续强化 v0.12.0 的 WebUI / Observatory，不改变 LifeEngine 核心数据库 schema。重点是把 WebUI 从静态轮询面板升级为更像“运行时观察台”的界面：实时更新、事件详情、梦境详情、Trace explain、Owner 切换、可点击的 schedule timeline，以及更清晰的小人状态动效。
...
v0.12.2 在 CSS 上增加了 live indicator、状态符文、detail drawer、hover 可点击状态和更多状态动效。
