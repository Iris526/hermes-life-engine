...
`life_living(action="day_rhythm", preset="temple_life")` creates concrete events and schedule blocks through LifeOps:
...
and initializes items such as 符纸、朱砂墨、香、小型结界仪、铜铃、小道观钥匙、委托记录册、干净道袍、茶叶、十二城小点心.
...
```json
{"action":"day_rhythm","preset":"temple_life","date":"2030-01-02"}
```
